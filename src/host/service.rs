...
impl HvncService {
    ...
    fn handle_launch_request(
        ...
        // Note: server.start() is async, but this function is not async
        // For now, removing the auto_setup call as it doesn't exist
        // TODO: Make this function async or handle server startup differently
